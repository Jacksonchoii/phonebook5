...
<body>
	...
	<c:forEach items="${requestScope.pList}" var="personVo"> <!-- requestScope.pList -->
		<table border="1">
			<tr>
				<td>이름(name)</td>
				<td>${personVo.name}</td> <!-- setter getter에서 값 가져오는 것 -->
			</tr>
			<tr>
				<td>핸드폰(hp)</td>
				<td>${personVo.hp}</td>
			...
			<tr>
				...
				<%-- <td><a href="/phonebook5/phone/delete2?personId=${personVo.personId}">[삭제2]</a></td> --%>
			</tr>
		</table>
		<br>
	</c:forEach>
